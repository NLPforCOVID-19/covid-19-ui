  ...
  return (
      <div className="news">
            <div className="title text-info">
                ...
                <a href="{mainUrl}" target="_blank" rel="noreferrer">&thinsp;{title}</a>
                {altUrl && (
                    <span>
                        <a href="{altUrl}" target="_blank" rel="noreferrer" title={t('元の言語で表示')}>&thinsp;<Icons.OpenInNew /></a>
                    </span>
                )}
                <span className="source small">
                    <a href="{sourceUrl}" target="_blank" rel="noreferrer">&thinsp;{sourceName}</a>
                </span>
            </div>
          <style jsx>{`
              .wrap {
